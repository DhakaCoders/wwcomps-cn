...
?>
	...
	<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button button alt <?php echo 'yes' === $use_ticket_numbers && "yes" !== $random_ticket_numbers ? ' lottery-must-pick ' : ''; echo true === $use_answers ? ' lottery-must-answer ' : '' ; ?>" ><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
