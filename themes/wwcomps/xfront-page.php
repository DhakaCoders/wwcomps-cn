             ...
             <div class="lates-winners-slider-filter">
                 <div class="filter-tabbar">
                  <ul class="filter reset-list">
                    <li class="filter-btn active" data-attribute="all"><a href="#">ALL</a></li>
                    <?php 
        ...
        <div class="row">
          <div class="col-md-12">
             <div class="lates-winners-slider-filter">
                 <div class="filter-tabbar">
                  <ul class="filter reset-list">
                    <li class="win-filter-btn active" data-attribute="all"><a href="#">ALL</a></li>
                    <?php 
                      foreach( $winnercats as $wincat ): 
                      $win_term = $wincat['select_category'];
                    ?>
                      <li class="win-filter-btn" data-attribute="<?php echo $win_term->slug; ?>"><a class="<?php echo $win_term->slug; ?>" href="#"><?php echo $win_term->name; ?></a></li>
                    <?php endforeach; ?>
                  </ul>
                </div>
             </div>
