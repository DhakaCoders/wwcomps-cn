...
<div class="cart-total-wrap-crtl">
	<div class="wc-cart-crtl">
		<h2>ITEMS</h2>
				...
				<tbody>
					...
					<tr>
						<td colspan="6" class="actions">
							...
							<button id="update_cart" type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
