          ...
          <div class="lates-winners-slider-filter">
            <div class="filter-tabbar winr-tabbar">
              <ul class="filter reset-list">
                <li><a class="all" href="<?php echo get_link_by_page_template( 'page-competition-winners.php' ); ?>">ALL</a></li>
                <?php foreach( $terms as $term ): ?>
                <li<?php echo (isset($curt_term->term_id) && ($curt_term->term_id == $term->term_id))?' class="active"':''; ?>><a data-filter="<?php echo $term->slug; ?>" class="<?php echo $term->name; ?>" href="<?php echo esc_url(get_term_link( $term )); ?>"><?php echo $term->slug; ?></a></li>
            	<?php endforeach; ?>
              </ul>
            </div>
          </div>
